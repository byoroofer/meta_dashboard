...
export const dashboardRepository = {
  ...
  getIntegrationTargets: async () => integrationTargets,
  getIntegrationTargetById: async (targetId: string) => integrationTargets.find((item) => item.id === targetId) ?? null,
  getCommandTemplates: async () => commandTemplates,
  getCommandTemplateById: async (templateId: string) => commandTemplates.find((item) => item.id === templateId) ?? null,
  getCommandExecutions: async () => commandExecutions,
