...
export const dashboardRepository = {
  ...
  getAutoResponderRules: async () => autoResponderRules,
  getAutoResponderRuleById: async (ruleId: string) => autoResponderRules.find((item) => item.id === ruleId) ?? null,
  ...
  getLeadDestinations: async () => leadDestinations,
  getLeadDestinationById: async (destinationId: string) => leadDestinations.find((item) => item.id === destinationId) ?? null,
